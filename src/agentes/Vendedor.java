...
public class Vendedor extends jade.core.Agent {
    ...
    public static VendedorVentana      interfazz;
    ...
    protected void setup() {
        ...
        //Saludamos
        System.out.println("Hola! Vendedor : " + getAID().getName() + " -> listo");

        //GUI se usa un Agente como parametro en el constructor
        interfazz = new VendedorVentana( this );
        //dar el nombre del agente a la ventana
        interfazz.setTitle( this.getAID().getName() );
        
        interfazz.setResizable(false);
        interfazz.setVisible(true);
    ...
    public void takeDown() {
        ...
        System.out.println("Adios vendedor!" + getAID().getName() + " ha finalizado.");
    ...
    public void anadirLibro(final String titulo, final double precioSalida, final double incremento) {
        addBehaviour( new OneShotBehaviour() {
            ...
            public void action() {
                ...
                interfazz.actualizarEstado(listaLibros);
            }
        });
    }
            ...
            public void action() {
                ...
                try {
                    ...
                    for (int i = 0; i < result.length; i++) {
                        ...
                        System.out.println("Comprador interesado " + i + ": " + pujadores[i].getName());
                    }
...
//                myAgent.send(rechazar);
    ...
    //Actualiza el estado de los libros en la interfazz
