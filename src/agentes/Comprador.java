...
public class Comprador extends jade.core.Agent {
    ...
    protected void setup() {
        ...
        //Saludamos
        System.out.println("---> Hola! " + getAID().getName() );
        ...
        interfaz.setTitle("Nombre: " + this.getAID().getName() );
                    ...
                    if (libro.getTitulo().equals(tituloLibro)) {
                        ...
                        if (libro.getPuja() >= precioLibro) {
                            ...
                            System.out.println("Comprador " +
                                    super.getAgent().getAID().getName() + 
                                    " se retira, libro fuera de presupuesto");
                            Mensaje.miMensaje("Se retira", "Comprador " +
                                    super.getAgent().getAID().getName() + 
                                    " se retira, libro fuera de presupuesto");
